            ...
            <form @submit.prevent="saveEmployee">
              ...
              <div class="mb-3">
                ...
                <div v-if="isEditMode && editForm.image" class="mt-2">
                  ...
                  <img :src="'http://localhost/app-vue01/php_api/uploads/' + editForm.image" width="100" class="mt-1 rounded" />
                </div>
              </div>
...
export default {
  ...
  setup() {
    ...
    const fetchEmployees = async () => {
      try {
        const res = await fetch("http://localhost/app-vue01/php_api/employees_img_crud.php");
